...
if __name__ == "__main__":
    ...
    source1_loc = np.array([5, 50+2.5, 1.5])
    source2_loc = np.array([5, 50-2.5, 1.5])
    source3_loc = np.array([50+45, 50, 1.5])
    ...
    # draw_spectogram(signal_das, fs, fft_size, fft_hop, analysis_window)
        ...
        sf.write(f'./results/3d/beamforming/20220315_{algoritm}_source{2}_frec{fc}.wav', signal_das_filtered.astype(np.int16), Fs)
