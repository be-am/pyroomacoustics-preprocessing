...
if __name__ == "__main__":
    ...
    # sr, souece1 = wavfile.read('./results/3d/beamforming/all_mix.wav')
    # sr, souece2 = wavfile.read('./results/3d/beamforming/das_source_0.wav')
    # sr, souece3 = wavfile.read('./results/3d/beamforming/das_source_1.wav')
    # print(souece1)
    convert_audio_to_spectogram('./results/3d/beamforming/all_mix.wav')
    convert_audio_to_spectogram('./results/3d/beamforming/perceptual_source_0.wav')
    convert_audio_to_spectogram('./results/3d/beamforming/perceptual_source_1.wav')
    plt.show()